...
contract Blockchase {
    ...
    mapping(string => uint8) public playerPositions;
    uint8 public previousEvaderPositions;
    uint8 public previousPursuerPositions;
    ...
    event EvaderMove(uint indexed currentGameID, uint8 indexed currentRound, uint8 previousEvaderIndex, uint8 newEvaderIndex);
    event PursuerMove(uint indexed currentGameID, uint8 indexed currentRounduint, uint8 previousPursuerIndex, uint8 newPursuerIndex);
    ...
    */
        ...
        onlyIfAuctionCanBeEnded
    {
        ...
        previousEvaderPositions = getCurrentEvaderIndex();
        previousPursuerPositions = getCurrentPursuerIndex();
        ...
        emit EvaderMove(currentGameID, currentRound, previousEvaderPositions, getCurrentEvaderIndex());
        emit PursuerMove(currentGameID, currentRound, previousPursuerPositions, getCurrentPursuerIndex());
